...
urlpatterns = [
    ...
    path('autenticacion/', include(('AutenticacionApp.urls','Autenticacion'), namespace='Autenticacion')),

    

    path('', include('KabasisWebApp.urls')),

    path('metodoPago/', include(('metodoPago.urls', 'metodoPago'), namespace='metodoPago')),
